...
public class Dock {
	...
	private String type;
	private int rent;
	private ArrayList<Ship> parkedShips;
	
	
	
	
	public Dock(int id, String name, int capacity, int basicCharge, int basicDuration, int extraCharge, String type,
			int rent, ArrayList<Ship> parkedShips) {
		super();
		this.id = id;
		this.name = name;
	...
	public ArrayList<Ship> getParkedShips() {
		return parkedShips;
	}
	public void setParkedShips(ArrayList<Ship> parkedShips) {
		this.parkedShips = parkedShips;
	}
